...
const ChannelParam CHANNEL_DEFAULT_PARAMS[] = {
	{31,  9, DEVICE_KIND_SPWM, {544UL, 2400UL, 0.0, 1000.0}, {1000UL, 5000UL, 0UL, 5000UL}, {0.0, 3000, YES}},
	{32,  6, DEVICE_KIND_SPWM, {544UL, 2400UL, 0.0, 1000.0}, {1000UL, 5000UL, 0UL, 5000UL}, {0.0, 3000, YES}},
	{33,  3, DEVICE_KIND_SPWM, {544UL, 2400UL, 0.0, 1000.0}, {1000UL, 5000UL, 0UL, 5000UL}, {0.0, 3000, YES}},
	{34, 11, DEVICE_KIND_SPWM, {544UL, 2400UL, 0.0, 1000.0}, {1000UL, 5000UL, 0UL, 5000UL}, {0.0, 3000, YES}},
	{35,  8, DEVICE_KIND_SPWM, {544UL, 2400UL, 0.0, 1000.0}, {1000UL, 5000UL, 0UL, 5000UL}, {0.0, 3000, YES}},
	{36,  5, DEVICE_KIND_SPWM, {544UL, 2400UL, 0.0, 1000.0}, {1000UL, 5000UL, 0UL, 5000UL}, {0.0, 3000, YES}}
